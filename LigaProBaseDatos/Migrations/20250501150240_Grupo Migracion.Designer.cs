...
{
    [DbContext(typeof(LigaProTallerContext))]
    [Migration("20250501150240_Grupo Migracion")]
    partial class GrupoMigracion
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LigaProBaseDatos.Models.Equipo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LigaProBaseDatos.Models.Jugador", b =>
                {
            ...
            modelBuilder.Entity("LigaProBaseDatos.Models.Jugador", b =>
                {
                    b.HasOne("LigaProBaseDatos.Models.Equipo", "Equipo")
                        .WithMany("Jugadores")
